...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    pageLabel: "Page",
    uploadTip: "Tip: You can select up to 10 court-order pages together. NyayVaani keeps them in page order.",
    ...
    uploadPageLimitError: "Upload one PDF up to 10 pages, or up to 10 page images.",
  ...
  hi: {
    ...
    pageLabel: "पेज",
    uploadTip: "सुझाव: आप अदालत के आदेश के अधिकतम 10 पेज एक साथ चुन सकते हैं। न्यायवाणी उन्हें सही क्रम में रखता है।",
    ...
    uploadPageLimitError: "एक PDF में अधिकतम 10 पेज या अधिकतम 10 पेज की तस्वीरें अपलोड करें।",
  ...
  bn: {
    ...
    pageLabel: "পৃষ্ঠা",
    uploadTip: "পরামর্শ: আদালতের আদেশের সর্বোচ্চ ১০টি পৃষ্ঠা একসঙ্গে নির্বাচন করতে পারেন। ন্যায়বাণী সেগুলো সঠিক ক্রমে রাখে।",
    ...
    uploadPageLimitError: "একটি PDF-এ সর্বোচ্চ ১০ পৃষ্ঠা অথবা সর্বোচ্চ ১০টি পৃষ্ঠার ছবি আপলোড করুন।",
  ...
  ta: {
    ...
    pageLabel: "பக்கம்",
    uploadTip: "குறிப்பு: நீதிமன்ற உத்தரவின் அதிகபட்சம் 10 பக்கங்களை ஒன்றாகத் தேர்ந்தெடுக்கலாம். நியாயவாணி அவற்றை சரியான வரிசையில் வைத்திருக்கும்.",
    ...
    uploadPageLimitError: "ஒரு PDF-இல் அதிகபட்சம் 10 பக்கங்கள் அல்லது அதிகபட்சம் 10 பக்கப் படங்களைப் பதிவேற்றவும்.",
  ...
  te: {
    ...
    pageLabel: "పేజీ",
    uploadTip: "సూచన: కోర్టు ఆదేశానికి సంబంధించిన గరిష్ఠంగా 10 పేజీలను ఒకేసారి ఎంచుకోవచ్చు. న్యాయవాణి వాటిని సరైన క్రమంలో ఉంచుతుంది.",
    ...
    uploadPageLimitError: "ఒక PDFలో గరిష్ఠంగా 10 పేజీలు లేదా గరిష్ఠంగా 10 పేజీ చిత్రాలను అప్‌లోడ్ చేయండి.",
  ...
  mr: {
    ...
    pageLabel: "पान",
    uploadTip: "सूचना: न्यायालयीन आदेशाची जास्तीत जास्त 10 पाने एकत्र निवडू शकता. न्यायवाणी त्यांचा योग्य क्रम राखते.",
    ...
    uploadPageLimitError: "एका PDFमध्ये जास्तीत जास्त 10 पाने किंवा जास्तीत जास्त 10 पानांच्या प्रतिमा अपलोड करा.",
  ...
  gu: {
    ...
    pageLabel: "પાનું",
    uploadTip: "સૂચન: કોર્ટના આદેશનાં વધુમાં વધુ 10 પાનાં એકસાથે પસંદ કરી શકો છો. ન્યાયવાણી તેમને યોગ્ય ક્રમમાં રાખે છે.",
    ...
    uploadPageLimitError: "એક PDFમાં વધુમાં વધુ 10 પાનાં અથવા વધુમાં વધુ 10 પાનાંની છબીઓ અપલોડ કરો.",
  ...
  pa: {
    ...
    pageLabel: "ਪੰਨਾ",
    uploadTip: "ਸੁਝਾਅ: ਤੁਸੀਂ ਅਦਾਲਤੀ ਹੁਕਮ ਦੇ ਵੱਧ ਤੋਂ ਵੱਧ 10 ਪੰਨੇ ਇਕੱਠੇ ਚੁਣ ਸਕਦੇ ਹੋ। ਨਿਆਇਵਾਣੀ ਉਨ੍ਹਾਂ ਨੂੰ ਸਹੀ ਕ੍ਰਮ ਵਿੱਚ ਰੱਖਦੀ ਹੈ।",
    ...
    uploadPageLimitError: "ਇੱਕ PDF ਵਿੱਚ ਵੱਧ ਤੋਂ ਵੱਧ 10 ਪੰਨੇ ਜਾਂ ਵੱਧ ਤੋਂ ਵੱਧ 10 ਪੰਨਿਆਂ ਦੀਆਂ ਤਸਵੀਰਾਂ ਅੱਪਲੋਡ ਕਰੋ।",
