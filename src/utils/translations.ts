...
export const TRANSLATIONS: Record<SupportedLanguage, TranslationDictionary> = {
  en: {
    ...
    uploadHeroBadge: "Sarvam Vision & Voice AI for Litigants",
    ...
    pageLabel: "Page",
    uploadTip: "Tip: You can select up to 10 court-order pages together. Sarvam Vision keeps them in page order.",
    ...
    uploadPageLimitError: "Sarvam Vision accepts one PDF up to 10 pages, or up to 10 page images.",
    ...
    analysisFailedError: "Sarvam could not analyze this court document. Please try again.",
    connectionError: "NyayVaani could not reach Sarvam AI. Check your connection and try again.",
  ...
  hi: {
    ...
    pageLabel: "पेज",
    uploadTip: "सुझाव: आप अदालत के आदेश के अधिकतम 10 पेज एक साथ चुन सकते हैं। सर्वम विज़न उन्हें सही क्रम में रखता है।",
    ...
    uploadPageLimitError: "सर्वम विज़न एक PDF में अधिकतम 10 पेज या अधिकतम 10 पेज की तस्वीरें स्वीकार करता है।",
    ...
    analysisFailedError: "सर्वम इस अदालत दस्तावेज़ का विश्लेषण नहीं कर सका। कृपया फिर कोशिश करें।",
    connectionError: "न्यायवाणी सर्वम AI से जुड़ नहीं सकी। अपना इंटरनेट जांचकर फिर कोशिश करें।",
  ...
  bn: {
    ...
    pageLabel: "পৃষ্ঠা",
    uploadTip: "পরামর্শ: আদালতের আদেশের সর্বোচ্চ ১০টি পৃষ্ঠা একসঙ্গে নির্বাচন করতে পারেন। সর্বম ভিশন সেগুলো সঠিক ক্রমে রাখে।",
    ...
    uploadPageLimitError: "সর্বম ভিশন একটি PDF-এ সর্বোচ্চ ১০ পৃষ্ঠা অথবা সর্বোচ্চ ১০টি পৃষ্ঠার ছবি গ্রহণ করে।",
    ...
    analysisFailedError: "সর্বম এই আদালতের নথি বিশ্লেষণ করতে পারেনি। আবার চেষ্টা করুন।",
    connectionError: "ন্যায়বাণী সর্বম AI-এর সঙ্গে সংযোগ করতে পারেনি। ইন্টারনেট পরীক্ষা করে আবার চেষ্টা করুন।",
  ...
  ta: {
    ...
    uploadHeroBadge: "சர்வம் டாக் AI மற்றும் குரல் AI இயந்திரம்",
    uploadHeading: "நீதிமன்ற உத்தரவுகளை உங்கள் மொழியில் உடனடியாகப் புரிந்து கொள்ளுங்கள்",
    uploadSubheading: "எந்தவொரு இந்திய நீதிமன்ற உத்தரவின் புகைப்படம் அல்லது ஸ்கேனைப் பதிவேற்றவும். சர்வம் டாக் AI நீதிபதியின் உத்தரவைத் தனியாகப் பிரித்து எளிய தமிழில் விளக்குகிறது.",
    ...
    pageLabel: "பக்கம்",
    uploadTip: "குறிப்பு: நீதிமன்ற உத்தரவின் அதிகபட்சம் 10 பக்கங்களை ஒன்றாகத் தேர்ந்தெடுக்கலாம். சர்வம் விஷன் அவற்றை சரியான வரிசையில் வைத்திருக்கும்.",
    ...
    uploadPageLimitError: "சர்வம் விஷன் ஒரு PDF-இல் அதிகபட்சம் 10 பக்கங்கள் அல்லது அதிகபட்சம் 10 பக்கப் படங்களை ஏற்கிறது.",
    ...
    analysisFailedError: "சர்வம் இந்த நீதிமன்ற ஆவணத்தைப் பகுப்பாய்வு செய்ய முடியவில்லை. மீண்டும் முயலுங்கள்.",
    connectionError: "நியாயவாணியால் சர்வம் AI-ஐ அணுக முடியவில்லை. இணைய இணைப்பைச் சரிபார்த்து மீண்டும் முயலுங்கள்.",
  ...
  te: {
    ...
    pageLabel: "పేజీ",
    uploadTip: "సూచన: కోర్టు ఆదేశానికి సంబంధించిన గరిష్ఠంగా 10 పేజీలను ఒకేసారి ఎంచుకోవచ్చు. సర్వం విజన్ వాటిని సరైన క్రమంలో ఉంచుతుంది.",
    ...
    uploadPageLimitError: "సర్వం విజన్ ఒక PDFలో గరిష్ఠంగా 10 పేజీలు లేదా గరిష్ఠంగా 10 పేజీ చిత్రాలను స్వీకరిస్తుంది.",
    ...
    analysisFailedError: "సర్వం ఈ కోర్టు పత్రాన్ని విశ్లేషించలేకపోయింది. మళ్లీ ప్రయత్నించండి.",
    connectionError: "న్యాయవాణి సర్వం AIను చేరుకోలేకపోయింది. ఇంటర్నెట్‌ను తనిఖీ చేసి మళ్లీ ప్రయత్నించండి.",
  ...
  mr: {
    ...
    pageLabel: "पान",
    uploadTip: "सूचना: न्यायालयीन आदेशाची जास्तीत जास्त 10 पाने एकत्र निवडू शकता. सर्वम व्हिजन त्यांचा योग्य क्रम राखते.",
    ...
    uploadPageLimitError: "सर्वम व्हिजन एका PDFमध्ये जास्तीत जास्त 10 पाने किंवा जास्तीत जास्त 10 पानांच्या प्रतिमा स्वीकारते.",
    ...
    analysisFailedError: "सर्वमला या न्यायालयीन दस्तऐवजाचे विश्लेषण करता आले नाही. पुन्हा प्रयत्न करा.",
    connectionError: "न्यायवाणी सर्वम AIशी जोडू शकली नाही. इंटरनेट तपासून पुन्हा प्रयत्न करा.",
  ...
  gu: {
    ...
    uploadSubheading: "કોઈપણ ભારતીય કોર્ટના ઓર્ડરનો ફોટો અથવા સ્કેન અપલોડ કરો. સર્વમ ડોક AI જજ સાહેબના આદેશને અલગ કરે છે અને સરળ ગુજરાતીમાં બોલીને સંભળાવે છે.",
    ...
    pageLabel: "પાનું",
    uploadTip: "સૂચન: કોર્ટના આદેશનાં વધુમાં વધુ 10 પાનાં એકસાથે પસંદ કરી શકો છો. સર્વમ વિઝન તેમને યોગ્ય ક્રમમાં રાખે છે.",
    ...
    uploadPageLimitError: "સર્વમ વિઝન એક PDFમાં વધુમાં વધુ 10 પાનાં અથવા વધુમાં વધુ 10 પાનાંની છબીઓ સ્વીકારે છે.",
    ...
    analysisFailedError: "સર્વમ આ કોર્ટ દસ્તાવેજનું વિશ્લેષણ કરી શક્યું નથી. ફરી પ્રયાસ કરો.",
    connectionError: "ન્યાયવાણી સર્વમ AI સુધી પહોંચી શકી નથી. ઇન્ટરનેટ તપાસીને ફરી પ્રયાસ કરો.",
  ...
  pa: {
    ...
    pageLabel: "ਪੰਨਾ",
    uploadTip: "ਸੁਝਾਅ: ਤੁਸੀਂ ਅਦਾਲਤੀ ਹੁਕਮ ਦੇ ਵੱਧ ਤੋਂ ਵੱਧ 10 ਪੰਨੇ ਇਕੱਠੇ ਚੁਣ ਸਕਦੇ ਹੋ। ਸਰਵਮ ਵਿਜ਼ਨ ਉਨ੍ਹਾਂ ਨੂੰ ਸਹੀ ਕ੍ਰਮ ਵਿੱਚ ਰੱਖਦਾ ਹੈ।",
    ...
    uploadPageLimitError: "ਸਰਵਮ ਵਿਜ਼ਨ ਇੱਕ PDF ਵਿੱਚ ਵੱਧ ਤੋਂ ਵੱਧ 10 ਪੰਨੇ ਜਾਂ ਵੱਧ ਤੋਂ ਵੱਧ 10 ਪੰਨਿਆਂ ਦੀਆਂ ਤਸਵੀਰਾਂ ਸਵੀਕਾਰ ਕਰਦਾ ਹੈ।",
    ...
    analysisFailedError: "ਸਰਵਮ ਇਸ ਅਦਾਲਤੀ ਦਸਤਾਵੇਜ਼ ਦਾ ਵਿਸ਼ਲੇਸ਼ਣ ਨਹੀਂ ਕਰ ਸਕਿਆ। ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
    connectionError: "ਨਿਆਇਵਾਣੀ ਸਰਵਮ AI ਨਾਲ ਜੁੜ ਨਹੀਂ ਸਕੀ। ਇੰਟਰਨੈੱਟ ਜਾਂਚ ਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।",
